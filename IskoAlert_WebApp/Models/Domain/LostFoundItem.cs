...
namespace IskoAlert_WebApp.Models.Domain
{
    public class LostFoundItem
    {
        ...
        public LostFoundItem(int userId, string title, string description,ItemStatus status, string email, CampusLocation location, ItemCategory category,string image)
        {
        ...
        public void Update(string title, string description, ItemStatus status, string email, CampusLocation location, ItemCategory category, string image)
        {
