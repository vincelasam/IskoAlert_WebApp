...
namespace IskoAlert_WebApp.Migrations
{
    ...
    [Migration("20260116211834_AddNotif")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IskoAlert_WebApp.Models.Domain.Notification", b =>
                {
                    ...
                    b.Property<int?>("LostFoundItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IskoAlert_WebApp.Models.Domain.Notification", b =>
                {
                    b.HasOne("IskoAlert_WebApp.Models.Domain.IncidentReport", "IncidentReport")
                        .WithMany()
                        .HasForeignKey("IncidentReportId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("IskoAlert_WebApp.Models.Domain.LostFoundItem", "LostFoundItem")
                        .WithMany()
                        .HasForeignKey("LostFoundItemId")
                        .OnDelete(DeleteBehavior.Cascade);
